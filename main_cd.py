...
if __name__ == '__main__':
    ...
    parser.add_argument('--multi_pred_weights', nargs = '+', type = float, default = [1/16, 1/8, 1])
    parser.add_argument('--net_G', default='base_transformer_pos_s4_dd8', type=str,
                        help='base_resnet18 | base_transformer_pos_s4 | '
                             'base_transformer_pos_s4_dd8 | '
                             'base_transformer_pos_s4_dd8_dedim8|ChangeRD|SiamUnet_diff')
