...
from models.losses import get_alpha, softmax_helper, FocalLoss, mIoULoss, mmIoULoss, cdloss, soft_cross_entropy
...
class CDTrainer():
    ...
    def _collect_running_batch_states(self):
        ...
        if np.mod(self.batch_id, 100) == 1:
            message = 'Is_training: %s. [%d,%d][%d,%d], imps: %.2f, est: %.2fh, G_loss: %.5f, running_mf1: %.5f\n' %\
                     ...
                     self.loss_metric.avg, running_acc)
    ...
    def _backward_G(self):
        ...
        self.loss_metric.update(self.G_loss.item())
